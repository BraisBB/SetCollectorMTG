...
public class ServiceConfiguration {
     ...
     * con CardDeckService
     */
        @Bean    @Primary    public DeckService deckService(            DeckRepository deckRepository,            UserRepository userRepository,            DeckMapper deckMapper,            CurrentUserUtil currentUserUtil) {        return new DeckServiceImpl(deckRepository, userRepository, deckMapper, currentUserUtil);    }
} 